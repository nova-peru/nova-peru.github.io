          ...
          <div className="flex space-x-12">
            <div className="flex-1">
              ...
              <p className="mt-4 text-base md:mt-12 lg:mt-12 lg:text-2xl">
                Fomenta relaciones significativas y de alto valor entre tu
                empresa y tus clientes.
              </p>

              <div className="mt-4 flex flex-col space-y-2 md:mt-12 md:flex-row md:space-x-2 md:space-y-0">
                <button className="rounded-md bg-body-color px-9 py-4 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-80 hover:shadow-signUp">
                  Ver Planes
                </button>
