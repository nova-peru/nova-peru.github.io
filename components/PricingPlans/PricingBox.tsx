import { buildWspLinkWithPlan } from '@/utils/buildWspLink';
...
const PricingBox = (props: {
  ...
  const { price, duration, packageName, subtitle, children, customPrice } =
    props;
    ...
    <div className="w-full">
      ...
      >
        <div className="flex items-center justify-between">
          {customPrice ? (
            ...
            <h3 className="price mb-2 text-3xl font-bold text-black dark:text-white">
              ...
              <span className="time text-body-color"> al {duration}</span>
            </h3>
          )}
        ...
        <div className="mb-8 border-b border-body-color border-opacity-10 pb-8 dark:border-white dark:border-opacity-10">
          <a
            href={buildWspLinkWithPlan(packageName)}
            target="_blank"
